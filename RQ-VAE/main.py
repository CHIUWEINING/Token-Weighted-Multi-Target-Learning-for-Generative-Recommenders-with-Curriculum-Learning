...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str, default="/tmp/wmir_final_dataset/", help="Input data path.")
    ...
    parser.add_argument("--sk_iters", type=int, default=0, help="max sinkhorn iters")
    ...
    parser.add_argument('--beta', type=float, default=0, help='diversity loss weight')
    ...
    parser.add_argument('--cf_emb', type=str, default=None, help='cf emb')
    ...
    parser.add_argument("--dataset", type=str, default="Random_Hashing_Industrial_and_Scientific", help="dataset name")
...
if __name__ == '__main__':
    ...
    """build dataset"""
    data = EmbDataset(args.data_path, args)
