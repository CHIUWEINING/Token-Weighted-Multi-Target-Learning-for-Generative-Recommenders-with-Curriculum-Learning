...
def parse_global_args(parser):
    ...
    parser.add_argument("--eval_mode", type=str, default="",
                        help="evaluation mode: cold, warm, all")
    parser.add_argument("--group_match", type=str, default=None,
                        help="group match then correct. 3, 2, 1.")

    parser.add_argument("--dist_eval", action="store_true", default=False,
                        help="eval the embedding distance between prediction and target")
    parser.add_argument("--partial_correct", action="store_true", default=False,
                        help="whether the prediction is partially correct")    
...
def parse_train_args(parser):
    ...
    parser.add_argument("--igdbeta", type=float, default=0.1) # for igd
...
def parse_test_args(parser):
    ...
    parser.add_argument("--ckpt_path1", type=str,
                        default="./ckpt",
                        help="The checkpoint path")
    ...
    parser.add_argument("--metrics", type=str, default="hit@1,hit@5,hit@10,ndcg@5,ndcg@10,hit@20,ndcg@20",
    ...
    parser.add_argument("--output_predictions", action="store_true", default=False,
                        help="whether output predictions")
